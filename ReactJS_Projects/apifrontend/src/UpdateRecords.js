...
class UpdateRecords extends React.Component {
  ...
  updateProduct(event){
    ...
    axios.put('http://localhost:8085/api/products/',{
                id:this.state.id,
  ...
  render() {
    return <div>
            ...
            <button onClick={this.updateProduct.bind(this)}>Update Product</button> <br/>
          
            <h2>New Record Updated </h2>
